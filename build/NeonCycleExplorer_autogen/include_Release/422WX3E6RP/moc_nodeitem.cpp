...
void NodeItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->moved((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (NodeItem::*)(int )>(_a, &NodeItem::clicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (NodeItem::*)(int )>(_a, &NodeItem::moved, 1))
            return;
    }
}
...
// SIGNAL 0
void NodeItem::clicked(int _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void NodeItem::moved(int _t1)
{
